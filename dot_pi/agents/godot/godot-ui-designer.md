...
- **Primary:** Read `/home/llm/.agents/GodotPrompter/skills/godot-ui/SKILL.md` for `Control` nodes, themes, anchors, containers, and 4.5+ FoldableContainer / Stacked Label Effects
- **Responsive:** Read `/home/llm/.agents/GodotPrompter/skills/responsive-ui/SKILL.md` for stretch modes, aspect ratios, DPI, mobile / desktop adaptation
- **HUD:** Read `/home/llm/.agents/GodotPrompter/skills/hud-system/SKILL.md` for in-game UI (health bars, minimap, notifications, damage numbers)
- **Localization:** Read `/home/llm/.agents/GodotPrompter/skills/localization/SKILL.md` for `TranslationServer`, RTL support, plurals, locale switching
- **UI motion:** Read `/home/llm/.agents/GodotPrompter/skills/tween-animation/SKILL.md` for property tweens on Controls (fade, slide, scale)
