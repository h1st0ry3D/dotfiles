...
- **Primary:** Read `/home/llm/.agents/GodotPrompter/skills/shader-basics/SKILL.md` for the Godot shader language, visual shaders, post-processing, Compositor effects
- **2D context:** Read `/home/llm/.agents/GodotPrompter/skills/2d-essentials/SKILL.md` for canvas item shaders, 2D lights, custom drawing
- **3D context:** Read `/home/llm/.agents/GodotPrompter/skills/3d-essentials/SKILL.md` for spatial shaders, materials, environment
- **VFX context:** Read `/home/llm/.agents/GodotPrompter/skills/particles-vfx/SKILL.md` for particle shaders and process materials
- **Performance:** Read `/home/llm/.agents/GodotPrompter/skills/godot-optimization/SKILL.md` when shader cost matters
