...
- **Primary:** Read `/home/llm/.agents/GodotPrompter/skills/godot-optimization/SKILL.md` for the bottleneck taxonomy and standard fixes
- **Subsystem skills:** Read whichever applies given the bottleneck:
  - Physics-bound → `/home/llm/.agents/GodotPrompter/skills/physics-system/SKILL.md`
  - Shader/fillrate → `/home/llm/.agents/GodotPrompter/skills/shader-basics/SKILL.md`
  - GC pressure (C#) → `/home/llm/.agents/GodotPrompter/skills/csharp-godot/SKILL.md`
  - Scripts hot path → `/home/llm/.agents/GodotPrompter/skills/gdscript-patterns/SKILL.md`
  - Particle count → `/home/llm/.agents/GodotPrompter/skills/particles-vfx/SKILL.md`
  - Animation cost → `/home/llm/.agents/GodotPrompter/skills/animation-system/SKILL.md`
  - Main-thread stalls / parallelizable work → `/home/llm/.agents/GodotPrompter/skills/multithreading/SKILL.md`
- **Debugging:** Read `/home/llm/.agents/GodotPrompter/skills/godot-debugging/SKILL.md` for profiler usage
