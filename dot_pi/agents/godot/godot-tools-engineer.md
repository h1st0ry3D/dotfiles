...
- **Primary:** Read `/home/llm/.agents/GodotPrompter/skills/addon-development/SKILL.md` for plugin scaffolding, EditorPlugin lifecycle, custom inspectors, custom resource editors, gizmos, plugin testing
- **GDScript depth:** Read `/home/llm/.agents/GodotPrompter/skills/gdscript-advanced/SKILL.md` for `@tool` lifecycle correctness (section 4) and metaprogramming (section 3)
- **GDScript fundamentals:** Read `/home/llm/.agents/GodotPrompter/skills/gdscript-patterns/SKILL.md` for typed exports and signal patterns
- **C#:** Read `/home/llm/.agents/GodotPrompter/skills/csharp-godot/SKILL.md` for project setup; `/home/llm/.agents/GodotPrompter/skills/csharp-signals/SKILL.md` for `[Signal]` delegates in plugin contexts
- **Native:** Read `/home/llm/.agents/GodotPrompter/skills/gdextension/SKILL.md` when a tool needs native C++/Rust (godot-cpp, `.gdextension`, class binding)
- **Debugging:** Read `/home/llm/.agents/GodotPrompter/skills/godot-debugging/SKILL.md` for plugin reload diagnosis and common errors
