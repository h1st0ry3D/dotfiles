...
- **Primary:** Read `/home/llm/.agents/GodotPrompter/skills/animation-system/SKILL.md` for AnimationPlayer, AnimationTree, blend spaces, animation state machines, IKModifier3D family, BoneConstraint3D, retargeting
- **Procedural motion:** Read `/home/llm/.agents/GodotPrompter/skills/tween-animation/SKILL.md` for code-driven property animation that complements (not replaces) AnimationPlayer
- **2D context:** Read `/home/llm/.agents/GodotPrompter/skills/2d-essentials/SKILL.md` for sprite animation and AnimatedSprite2D
- **3D context:** Read `/home/llm/.agents/GodotPrompter/skills/3d-essentials/SKILL.md` for skeletal context and materials affected by animation
- **Boundary:** Read `/home/llm/.agents/GodotPrompter/skills/state-machine/SKILL.md` to know where animation FSM ends and gameplay FSM begins
- **Debugging:** Read `/home/llm/.agents/GodotPrompter/skills/godot-debugging/SKILL.md` for animation tree debugging
